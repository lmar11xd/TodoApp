...
import com.lmar.todoapp.feature_todo.domain.use_case.TodoUseCaseResult
import com.lmar.todoapp.feature_todo.domain.use_case.TodoUseCases
    ...
    fun onEvent(event: TodoListEvent) {
        when(event) {
            ...
            is TodoListEvent.Sort -> {
                val stateOrderAllreadyMatchesEventOrder =
            ...
            is TodoListEvent.ToggleCompleted -> {
                viewModelScope.launch(dispatcher + errorHandler) {
                    todoUseCases.toogleCompleteTodoItem(todo = event.todo)
                    getTodoItems()
                }
            }
