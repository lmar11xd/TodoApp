package com.lmar.todoapp.feature_todo.domain.use_case

import com.lmar.todoapp.core.util.TodoUseCaseStrings
import com.lmar.todoapp.feature_todo.domain.model.TodoItem
import com.lmar.todoapp.feature_todo.domain.repo.TodoListRepo
import com.lmar.todoapp.feature_todo.domain.util.InvalidTodoItemException
import com.lmar.todoapp.feature_todo.domain.util.SortingDirection
...
class TodoUseCases @Inject constructor(
    ...
    suspend fun toogleCompleteTodoItem(todo: TodoItem) {
