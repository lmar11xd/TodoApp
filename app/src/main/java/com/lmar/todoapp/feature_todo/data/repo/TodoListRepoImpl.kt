package com.lmar.todoapp.feature_todo.data.repo

import android.util.Log
import com.lmar.todoapp.feature_todo.data.di.IoDispatcher
import com.lmar.todoapp.feature_todo.data.local.TodoDao
import com.lmar.todoapp.feature_todo.data.mapper.toLocalTodoItem
import com.lmar.todoapp.feature_todo.data.mapper.toLocalTodoItemListFromRemote
import com.lmar.todoapp.feature_todo.data.mapper.toRemoteTodoItem
import com.lmar.todoapp.feature_todo.data.mapper.toTodoItem
import com.lmar.todoapp.feature_todo.data.mapper.toTodoItemListFromLocal
...
class TodoListRepoImpl(
    ...
    override suspend fun updateTodoItem(todo: TodoItem) {
        ...
        api.updatedTodoItem(todo.id, todo.toRemoteTodoItem())
    }
